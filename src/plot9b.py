...
r_x_1 = np.loadtxt("./out/xy1_inter.txt", usecols=0, dtype="double")
r_y_1 = np.loadtxt("./out/xy1_inter.txt", usecols=1, dtype="double")

r_x_2 = np.loadtxt("./out/xy2_inter.txt", usecols=0, dtype="double")
r_y_2 = np.loadtxt("./out/xy2_inter.txt", usecols=1, dtype="double")
