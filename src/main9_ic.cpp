...
int main()
{
    ...
    if (trap.interaction)
    {
        position_out_filename = "./out/r_xy_inter_1_2_ic.txt";
        velocity_out_filename = "./out/v_xy_inter_1_2_ic.txt";
    }
    else
    {
        position_out_filename = "./out/r_xy_nointer_1_2_ic.txt";
        velocity_out_filename = "./out/v_xy_nointer_1_2_ic.txt";
    }
