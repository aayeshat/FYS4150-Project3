...
public:
    ...
    {
        B0 = B0_in; //Magnetic field
        V0 = V0_in; //Applied Potential
        d = d_in;  //Dimension
        n = n_in; //Number of particles
    }
...
/*         mat initial_r = mat(3,number_of_particles);
        ...
        mat K1_r = mat(3, number_of_particles);
        mat K1_v = mat(3, number_of_particles);
        mat K2_r = mat(3, number_of_particles);
        mat K2_v = mat(3, number_of_particles);
        mat K3_r = mat(3, number_of_particles);
        mat K3_v = mat(3, number_of_particles);
        mat K4_r = mat(3, number_of_particles);
        mat K4_v = mat(3, number_of_particles);
        ...
        { //K1
            ...
            K1_r.col(i) = dt * p_i.v;
            K1_v.col(i) = dt * total_force(i) / m;

            p_i.r = p_old_i.r + K1_r.col(i);
            p_i.v = p_old_i.v + K1_v.col(i);
        }
        ...
        { //K2
            ...
            K2_r.col(i) = dt * p_i.v;
            K2_v.col(i) = dt * total_force(i) / m;

            p_i.r = p_old_i.r + K2_r.col(i) / 2;
            p_i.v = p_old_i.v + K2_v.col(i) / 2;
        }
        ...
        for (int k = 0; k <= number_of_particles; k++)
        {
            ...
            K3_r.col(i) = dt * p_i.v;
            K3_v.col(i) = dt * total_force(i) / m;

            p_i.r = p_old_i.r + K3_r.col(i) / 2;
            p_i.v = p_old_i.v + K3_v.col(i) / 2;
        }
        ...
        for (int k = 0; k <= number_of_particles; k++)
        {
            ...
            K4_r.col(i) = dt * p_i.v;
            K4_v.col(i) = dt * total_force(i) / m;

            p_i.r = p_old_i.r + K4_r.col(i);
            p_i.v = p_old_i.v + K4_v.col(i);
        }
        ...
        vec r_step = p_old.r + K_sum_r.col(i) / 6;
        vec v_step = p_old.v + K_sum_v.col(i) / 6;
    ...
    //this function does not do anything I think
